...
let servicos = [];
let funcionarios = ["João Santos", "Maria Costa", "Pedro Lima"];
// ==============================================
...
function criarAnimal(nome, especie, idade, peso, cor, raca, dono, observacoes = "Novo animal cadastrado no sistema") {
    return {
...
function processarCadastroAnimal() {
...
function aplicarVacina(idAnimal) {
...
function atualizarContadores() {
    ...
    if (totalAnimais)
        totalAnimais.textContent = animais.length.toString();
    if (totalServicos)
        totalServicos.textContent = servicos.length.toString();
}
// ==============================================
